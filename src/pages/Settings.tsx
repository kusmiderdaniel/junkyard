  ...
  return (
    <div className="max-w-4xl mx-auto">
      <div className="mb-8">
        ...
        <p className="mt-4 text-gray-600">Zarządzaj swoim kontem i danymi aplikacji</p>
      </div>
      ...
      <div className="space-y-8">
        ...
        <div className="bg-white rounded-lg shadow-md p-6">
          <h2 className="text-xl font-semibold text-gray-800 mb-4">Dane Offline</h2>
          <p className="text-gray-600 mb-4">
            Zarządzaj danymi dostępnymi offline w aplikacji PWA. Dane są automatycznie cachowane gdy jesteś online.
          </p>
            ...
            {(() => {
              ...
              return (
                <div className="text-sm text-gray-600">
                  Cache: {cacheInfo.clientsCount} klientów, {cacheInfo.receiptsCount} kwitów
                </div>
              );
            })()}
          </div>
